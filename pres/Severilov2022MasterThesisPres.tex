...
\begin{frame}{LNN, учитывающая трансляционную и вращательную симметрии}
	\begin{block}{Нётеровская Лагранжева нейронная сеть}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\label{fig:five over x}
	\end{subfigure}
	\caption{Моделирование динамики системы двойного маятника различными видами нейронных сетей: аналитическое решение, полносвязная нейронная сеть, LSTM, LNN, модифицированной LNN.}
